...
const DailyProgram = ({ dailyProgram, setProgram, programType }) => {
	const items = dailyProgram.items;
	...
	const setItem = (newItem) => {
		...
		const completed = programType == 'trainings' ? getTotalSetsCompleted(newItems) : getTotalCaloriesConsumed(newItems);
	...
	const renderKPIs = () => {
		...
		return (programType == 'trainings' ? <View>
