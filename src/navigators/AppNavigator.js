...
const AppNavigator = () => {
	...
	const initiateData = async () => {
		...
		await getProgram(user.userName, "training");
		await getProgram(user.userName, "nutrition");
	};
	...
	console.log(programLoading);

	return (
		<NavigationContainer>
			{authLoading || userLoading || programLoading.training || programLoading.nutrition
				? loadingStack()
				: renderApp()}
		</NavigationContainer>
	);
